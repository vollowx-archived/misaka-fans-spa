    ...
    this.innerHTML = /* html */ `
      <div class="headline">
        ...
        <div class="info">
          ...
          <a class="github title-medium" href="https://github.com/${this.getAttribute('gh-name')}" title="TA 的 GitHub 主页：https://github.com/${this.getAttribute('gh-name')}">
          ...
          <a class="email title-medium" href="mailto:${this.getAttribute('email')}" title="TA 的邮箱：${this.getAttribute('email')}">
