    ...
    this.innerHTML = /* html */ `
      <div class="headline">
        ...
        <div class="info">
          ...
          <a class="standard-icon-button" href="https://github.com/${this.getAttribute('gh-name')}" title="TA 的 GitHub 主页：https://github.com/${this.getAttribute('gh-name')}">
          ...
          <a class="standard-icon-button" href="mailto:${this.getAttribute('email')}" title="TA 的邮箱：${this.getAttribute('email')}">
